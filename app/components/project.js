export default function Project() {
    return (
        <div id='product' className="max-w-6xl mx-3 md:mx-auto mb-12">
            <div className="md:grid grid-cols-2">
                <div>
                    ...
                    <a href="https://yaatrip.com/" target="_blank" rel="noopener noreferrer" className="hover:underline hover:text-primary mb-6 inline-block">
                        ↗ Explore
                    </a>
                </div>
            </div>
            <a href="https://yaatrip.com/" target="_blank" rel="noopener noreferrer" className="rounded-lg w-full flex items-center overflow-hidden h-[500px] bg-gray-100 hover:shadow-lg">
