...
export default function Hero() {
    ...
    return (
        <div className="relative bg-blue text-black py-20 px-4 h-[85vh] border-b border-primary">
            ...
            <div className="relative max-w-6xl mx-auto md:grid grid-cols-2">
                    <div>
                        ...
                        <button className="bg-green-600 text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-green-700 transition duration-300">Join us</button>
                    </div>
                </div>
